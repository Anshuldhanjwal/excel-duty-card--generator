      ...
      <table className="w-full h-full border-collapse" style={{ tableLayout: 'fixed' }}>
        ...
        <tbody>
          ...
          <tr>
            <td
              colSpan={4}
              className="text-center px-3 py-3 align-middle border-r border-b border-black"
            >
              <div className="text-[34px] font-extrabold leading-tight tracking-wide">
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-2.5 text-center font-bold align-middle text-[21px] bg-slate-50 print:bg-transparent">
              ड्यूटी का प्रकार
            </td>
            <td className="border-b border-r border-black px-2 py-2.5 text-center font-bold align-middle text-[21px] bg-slate-50 print:bg-transparent">
            ...
            <td className="border-b border-l-2 border-black px-2 py-2.5 text-center font-bold align-middle text-[21px] bg-slate-50 print:bg-transparent">
          ...
          <tr>
            ...
            <td
              ...
              className="border-b border-r border-black px-2 py-2.5 font-normal text-center align-middle text-[21px]"
            >
              {record.dutyType}
            </td>
            {/* Column B: Officer name (Bold for visibility) */}
            <td className="border-b border-r border-black px-2 py-2.5 font-bold align-middle text-[25px] leading-tight">
              {record.mainOfficerName}
            </td>
            {/* Column C: Posting place (Unbold) */}
            <td className="border-b border-r border-black px-2 py-2.5 font-normal text-center align-middle text-[21px]">
            ...
            <td
              ...
              className="border-b border-l-2 border-black px-3 py-2.5 font-normal text-center align-middle text-[21px] leading-snug"
            >
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-1.5 font-bold text-center align-middle text-[20px] bg-slate-50 print:bg-transparent">
          ...
          {displaySupporting.map((officer, index) => {
            ...
            return (
              <tr key={index}>
                ...
                <td className="border-b border-r border-black px-2 py-2.5 font-normal align-middle text-[22px] leading-tight">
                  {officer.name || '\u00A0'}
                </td>
                {/* Column C: Posting Place (Unbold) */}
                <td className="border-b border-r border-black px-2 py-2.5 font-normal text-center align-middle text-[21px]">
                ...
                {isLast && (
                  <td className="border-b border-l-2 border-black px-2 py-2 text-center align-middle font-bold text-[18px] bg-slate-50 print:bg-transparent">
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-2 font-bold align-middle text-[21px] bg-slate-50 print:bg-transparent">
              ड्यूटी का स्थान
            </td>
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-2.5 font-normal align-middle text-[21px]">
              {record.dutyPlace}
            </td>
            <td className="border-b border-r border-black px-2 py-2">{'\u00A0'}</td>
            <td className="border-b border-r border-black px-2 py-2">{'\u00A0'}</td>
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-2.5 font-normal align-middle text-[21px] leading-snug">
              {record.dutyTime}
            </td>
            <td className="border-b border-r border-black px-2 py-2">{'\u00A0'}</td>
            <td className="border-b border-r border-black px-2 py-2">{'\u00A0'}</td>
          ...
          <tr>
            ...
            <td className="border-b border-r border-black px-2 py-3">{'\u00A0'}</td>
            <td className="border-b border-r border-black px-2 py-3">{'\u00A0'}</td>
            <td className="border-b border-l-2 border-black px-3 py-3 font-normal text-center align-middle text-[21px] leading-snug">
          ...
          <tr>
            <td colSpan={5} className="px-4 pt-3 pb-2 text-right align-bottom">
              <span className="font-bold text-[22px] leading-snug">
