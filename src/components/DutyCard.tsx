      ...
      <table className="w-full border-collapse" style={{ tableLayout: 'fixed' }}>
        ...
        <tbody>
          ...
          <tr>
            <td
              colSpan={4}
              className="text-center px-3 py-2 align-middle border-r border-b border-black"
            >
              <div className="text-[28px] font-extrabold leading-tight tracking-wide">
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-2 text-center font-bold align-middle text-[17px]">
              ड्यूटी का प्रकार
            </td>
            <td className="border-b border-r border-black px-2 py-2 text-center font-bold align-middle text-[17px]">
            ...
            <td className="border-b border-l-2 border-black px-2 py-2 text-center font-bold align-middle text-[17px]">
          ...
          <tr>
            ...
            <td
              ...
              className="border-b border-r border-black px-2 py-2 font-normal text-center align-middle text-[17px]"
            >
              {record.dutyType}
            </td>
            ...
            <td className="border-b border-r border-black px-2 py-2 font-normal text-center align-middle text-[17px]">
            ...
            <td
              ...
              className="border-b border-l-2 border-black px-3 py-2 font-normal text-center align-middle text-[17px]"
            >
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-1 font-bold text-center align-middle text-[16px]">
          ...
          {displaySupporting.map((officer, index) => {
            ...
            return (
              <tr key={index}>
                ...
                <td className="border-b border-r border-black px-2 py-2 font-normal align-middle text-[17px]">
                  {officer.name || '\u00A0'}
                </td>
                {/* Column C: Posting Place (Unbold) */}
                <td className="border-b border-r border-black px-2 py-2 font-normal text-center align-middle text-[17px]">
                ...
                {isLast && (
                  <td className="border-b border-l-2 border-black px-2 py-2 text-center align-middle font-bold text-[15px]">
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-2 font-bold align-middle text-[17px]">
              ड्यूटी का स्थान
            </td>
          ...
          {/* ============================================ */}
          <tr>
            <td className="border-b border-r border-black px-2 py-2 font-normal align-middle text-[17px] leading-snug">
              {record.dutyTime}
            </td>
            <td className="border-b border-r border-black px-2 py-2">{'\u00A0'}</td>
            <td className="border-b border-r border-black px-2 py-2">{'\u00A0'}</td>
          ...
          <tr>
            ...
            <td className="border-b border-r border-black px-2 py-3">{'\u00A0'}</td>
            <td className="border-b border-r border-black px-2 py-3">{'\u00A0'}</td>
            <td className="border-b border-l-2 border-black px-3 py-3 font-normal text-center align-middle text-[17px]">
          ...
          <tr>
            <td colSpan={5} className="px-4 pt-3 pb-2 text-right align-bottom">
              <span className="font-bold text-[17px] leading-snug">
